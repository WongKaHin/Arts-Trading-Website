...
<body>
    ...
    <h1 class="title"><span class="Tchange">Pro</span>ducts <span class="Tchange">Pro</span>file</h1>
    <div class="page">
        <div class="page-box">
            <form class="login-form" method="POST" action="udproduct.jsp"> 
            <div class="member-infor">
                <div class="photo"><img class="member-photo" src="assets/images/product/product1-1.jpg" ></div>
                <div class="right">
                    <div class="data">
