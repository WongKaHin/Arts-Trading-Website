...
<body>
    ...
    <div class="page">
        <div class="page-box">
            ...
            <div class="btn">
                <a href="member-modify.html"><button class="btn-sty">修改個人資料</button></a>
                <a href="member-password.html"><button class="btn-sty">修改密碼</button></a>
                <a href="consumingrecord.html"><button class="btn-sty">購買紀錄</button></a>
                <a href="commentcord.html"><button class="btn-sty">評價紀錄</button></a>
            </div>    
        </div>
    </div>
    <hr>            
    ...
    <div class="page">
        <table class="recordlist">
            ...
            <%
            String sql1 = "SELECT * FROM `order` WHERE `會員id`= '"+session.getAttribute("ID")+"'";
            ...
            <tr class="list_body">
                ...
                <td><img src="<%=rs2.getString("圖片")%>"></td>
                <td><%=rs1.getString("產品名稱")%></td>
                <td><%=rs1.getString("數量")%></td>
                <td>$<%=rs1.getInt("total")%></td>
                <td><a href="productrecord.jsp"><button class="btn-re">評價</button></a></td>
            </tr>
            <%}}%>
        </table>
    </div>
